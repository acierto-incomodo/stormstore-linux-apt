...
echo "🔹 Instalando StormOS Repo (amd64)..."
...
echo "deb [arch=amd64 signed-by=/etc/apt/keyrings/stormos.gpg] https://acierto-incomodo.github.io/stormstore-linux-apt stable main" | sudo tee /etc/apt/sources.list.d/stormos.list
